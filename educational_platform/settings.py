...
SECRET_KEY = 'django-insecure-*cpk$=1*h!q+%#b7hbe%pgm7@m63%oy-cbxnlupdo^e+otsgdt'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "educational_platform", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "educational_platform" / "static",
]
